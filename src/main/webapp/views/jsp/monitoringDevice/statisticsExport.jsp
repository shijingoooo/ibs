...
<div class="pageContent">
	<form method="post" id="statisticsExportFormId" action="${ctx}/monitoringDevice/exportStatisticsExcel.action?rel=ibs_device_page&callbackType=closeCurrent" class="pageForm required-validate">
		<div class="pageFormContent" layoutH="56">
			...
			<br>
			<%--扬尘噪声、扬尘噪声（基础）显示指标--%>
			<c:if test="${deviceType==4 || deviceType==7}" >
