...
<div class="pageContent">
	<form method="post" action="${ctx}/monitoringDevice/exportExcel.action?rel=ibs_device_group2_page&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<h2 style="text-align: center">导出数据选项</h2>
			<p>
				<label>开始时间：</label>
				<input type="text" name="startDate" value="" class="date" size="30" /><a class="inputDateButton" href="javascript:;">选择</a>
			</p>
			<p>
				<label>结束时间：</label>
				<input type="text" name="endDate" value="" class="date" size="30" /><a class="inputDateButton" href="javascript:;">选择</a>
			</p>
			<br>
			<p>
				<label>导出指标：</label>
