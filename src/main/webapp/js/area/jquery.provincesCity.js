...
$.fn.ProvinceCity = function(province_,city1_,city2_){
	...
	//插入3个空的下拉框
	_self.append('<select name="province" id="province" style="margin-left: 25px;"></select>&nbsp;');
	_self.append('&nbsp;<select name="city" id="city" style="margin-left: 10px;"></select>&nbsp;');
	_self.append('&nbsp;<select name="district" id="district" style="margin-left: 10px;"></select>&nbsp;');
