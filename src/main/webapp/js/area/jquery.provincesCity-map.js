...
var GC =
    [
        ...
        [
            ['东城', '西城', '崇文', '宣武', '朝阳', '海淀', '丰台', '石景山', '通州', '顺义', '昌平', '门头沟', '房山', '大兴', '平谷', '怀柔', '密云', '延庆']
        ],
        [
        ...
        [
            ['和平', '皇姑', '铁西', '于洪', '浑南', '法库', '康平', '辽中', '沈阳市', '新民'],
            ['鞍山市', '海城', '台安', '岫岩'],
            ['本溪市', '本溪县', '桓仁'],
...
$.fn.ProvinceCity = function (province_, city1_, city2_) {
    ...
    //插入3个空的下拉框
    _self.append('<label id="l_province">省<select name="province" id="province" style="margin-left: 25px;"></select></label>&nbsp;');
    _self.append('&nbsp;<label id="l_city">市<select name="city" id="city" style="margin-left: 10px;"></select></label>&nbsp;');
    _self.append('&nbsp;<label>区域<select name="district" id="district" style="margin-left: 10px;"></select></label>&nbsp;');
    _self.append('&nbsp;<select name="county" id="county" style="display:none;"></select>');
    _self.append('&nbsp;<input type="button" id="searchMap" value="查询" style="height:24px;"/>');
    //分别获取3个下拉框
