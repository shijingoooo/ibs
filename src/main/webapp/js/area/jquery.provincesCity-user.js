...
$.fn.ProvinceCity = function (province_, city1_, city2_) {
    ...
    //插入3个空的下拉框
    _self.append('<select name="province" id="userProvince" style="margin-left: 25px;"></select>&nbsp;');
    _self.append('&nbsp;<select name="city" id="userCity" style="margin-left: 10px;"></select>&nbsp;');
    _self.append('&nbsp;<select name="district" id="userDistrict" style="margin-left: 10px;"></select>&nbsp;');
    ...
    $sel1.change(function () {
        ...
        if (index1 == 0 && $("#userProvince").val() == '请选择') {	//当选择的为 “请选择” 时
            ...
            if (typeof(GC[index1 - 1]) != "undefined") {
