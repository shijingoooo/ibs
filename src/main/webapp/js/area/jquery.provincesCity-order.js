...
$.fn.ProvinceCity = function(province_,city1_,city2_){
	...
	//插入3个空的下拉框
	_self.append('<select name="province" id="provinceOrder" style="margin-left: 25px;"></select>&nbsp;');
	_self.append('&nbsp;<select name="city" id="cityOrder" style="margin-left: 10px;"></select>&nbsp;');
	_self.append('&nbsp;<select name="district" id="districtOrder" style="margin-left: 10px;"></select>&nbsp;');
	_self.append('&nbsp;<select name="county" id="countyOrder" style="display:none;"></select>');
	//分别获取3个下拉框
	...
	$sel1.change(function(){
		...
		var index_ = 0;
		if(index1==0&&$("#provinceOrder").val() == '请选择'){	//当选择的为 “请选择” 时
